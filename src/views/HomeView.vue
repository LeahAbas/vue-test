...
<template>
  <main class="h-[calc(100vh-4rem)] md:h-[calc(100vh-5.6rem)] bg-hero-image bg-cover">
    <div class="h-full w-full bg-[rgba(0,0,0,0.65)] backdrop-blur-[5px] flex flex-col items-center pt-[6rem] md:pt-[8rem] px-[25px] md:px-0">
      <div class="relative w-full md:w-[33rem] h-[65vh] flex flex-col gap-[1.2rem] md:gap-[2rem] rounded-[2rem] md:rounded-[2.5rem] bg-[rgba(255,255,255,0.08)] backdrop-blur-[20px] p-[1.5rem] md:p-[2rem]">
        <div class="border border-transparent focus-within:border-accentColor h-[2.4rem] md:h-[3.125rem] w-full rounded-[3.125rem] bg-[rgba(255,255,255,0.50)] flex items-center justify-between px-[0.5rem] md:px-[0.94rem] shadow-[0px_2px_10px_0px_rgba(0,0,0,0.15)] backdrop-blur-[2.5px]">
          <input class="h-[70%] w-[80%] outline-none border-0 text-[0.75rem] md:text-[1rem] text-black bg-transparent pl-[0.7rem] md:pl-[1rem] placeholder:text-black" type="text" @input="debouncedSearch" v-model="search" autofocus placeholder="Enter a city name"/>
        ...
        <ul v-if="mapboxResult" class="z-[10] w-[88%] px-4 py-2 absolute top-[16%] md:top-[18%] left-[6%] rounded-[10px] bg-white shadow-xl">
